...
interface FloatingMenuState {
  ...
  ? employees.filter((e) => {
      ...
      if (selectedClientId && selectedClientId !== 'multiple') {
        ...
        // Multiple clients tab: only include employees with multiple relationships
        const hasMultiple = e.clientPayTypeRelationships && e.clientPayTypeRelationships.length > 1;
        return matchCompany && hasMultiple;
      }
                            ...
                            >
                              ...
                              {isPerDiem && (
                                <>
                                  ...
                                  {/* Per Diem Breakdown Fields - Always show for daily input */}
                                  <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', mb: 1 }}>
