...
import {
  ...
  Checkbox, ListItemText, IconButton, Divider
} from '@mui/material';
      ...
      {currentRole === 'admin' && (
        ...
        <DialogContent sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={newEmployee.hasMultipleClients || false}
                onChange={(e) => {
          ...
          {!newEmployee.hasMultipleClients && (
            <>
              <FormControl fullWidth>
                <InputLabel>Pay Types</InputLabel>
                <Select 
                  multiple
                  value={newEmployee.payTypes} 
                  onChange={(e) => {
                ...
                >
                  <MenuItem value="hourly">
                    <Checkbox checked={newEmployee.payTypes.indexOf('hourly') > -1} />
                    <ListItemText primary="Hourly" />
                  </MenuItem>
                  <MenuItem value="perdiem">
                    <Checkbox checked={newEmployee.payTypes.indexOf('perdiem') > -1} />
          ...
          {/* Only show pay rate and client if NOT using multiple clients mode */}
          {!newEmployee.hasMultipleClients && (
            <>
